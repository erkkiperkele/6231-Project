...
public class LoanHelper
{
     ...
     * @param t Loan value
     */
    public static void insert(org.omg.CORBA.Any a, Loan t)
    {
        a.insert_Streamable(new LoanHolder(t));
    }
     ...
     */
    public static Loan extract(org.omg.CORBA.Any a )
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.orb.core.Any) {
            ...
            try {
                ...
                if ( s instanceof LoanHolder)
                    return ( (LoanHolder) s ).value;
            }
            catch ( org.omg.CORBA.BAD_INV_ORDER ex )
            {
            }
            LoanHolder h = new LoanHolder( read( a.create_input_stream() ) );
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_tc == null) {
            synchronized(org.omg.CORBA.TypeCode.class) {
                ...
                _members[ 3 ].type = DateHelper.type();
     ...
     */
    public static Loan read(org.omg.CORBA.portable.InputStream istream)
    {
        Loan new_one = new Loan();

        new_one.loanNumber = istream.read_short();
        new_one.customerAccountNumber = istream.read_short();
        new_one.amount = istream.read_long();
        new_one.dueDate = DateHelper.read(istream);
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, Loan value)
    {
        ostream.write_short( value.loanNumber );
        ostream.write_short( value.customerAccountNumber );
        ostream.write_long( value.amount );
        DateHelper.write( ostream, value.dueDate );
    }
