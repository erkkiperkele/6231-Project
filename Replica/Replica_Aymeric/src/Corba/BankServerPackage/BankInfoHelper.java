...
public class BankInfoHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, BankInfo t)
    {
        a.insert_Streamable(new BankInfoHolder(t));
    }
     ...
     */
    public static BankInfo extract(org.omg.CORBA.Any a )
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.orb.core.Any) {
            ...
            try {
                ...
                if ( s instanceof BankInfoHolder)
                    return ( (BankInfoHolder) s ).value;
            }
            catch ( org.omg.CORBA.BAD_INV_ORDER ex )
            {
            }
            BankInfoHolder h = new BankInfoHolder( read( a.create_input_stream() ) );
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_tc == null) {
            synchronized(org.omg.CORBA.TypeCode.class) {
                ...
                _members[ 0 ].type = orb.create_sequence_tc( 0, CustomerInfoHelper.type() );
     ...
     */
    public static BankInfo read(org.omg.CORBA.portable.InputStream istream)
    {
        BankInfo new_one = new BankInfo();

        {
        int size7 = istream.read_ulong();
        new_one.customersInfo = new CustomerInfo[size7];
        for (int i7=0; i7<new_one.customersInfo.length; i7++)
         {
            new_one.customersInfo[i7] = CustomerInfoHelper.read(istream);
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, BankInfo value)
    {
        ostream.write_ulong( value.customersInfo.length );
        for ( int i7 = 0; i7 < value.customersInfo.length; i7++ )
        {
            CustomerInfoHelper.write( ostream, value.customersInfo[ i7 ] );
