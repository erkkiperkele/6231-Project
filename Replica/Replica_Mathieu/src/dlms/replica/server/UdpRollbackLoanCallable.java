...
public class UdpRollbackLoanCallable {
	 ...
	 * @param logger
	 */
	public UdpRollbackLoanCallable(Bank sourceBank, BankReplicaStub destinationBank, int loanId, int sequenceNbr, Logger logger) {
