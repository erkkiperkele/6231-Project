...
public class AccountHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, Account t)
    {
        a.insert_Streamable(new AccountHolder(t));
    }
    ...
    public static Account extract(org.omg.CORBA.Any a )
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.orb.core.Any) {
            ...
            try {
                ...
                if ( s instanceof AccountHolder)
                    return ( (AccountHolder) s ).value;
            }
            catch ( org.omg.CORBA.BAD_INV_ORDER ex )
            {
            }
            AccountHolder h = new AccountHolder( read( a.create_input_stream() ) );
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_tc == null) {
            synchronized(org.omg.CORBA.TypeCode.class) {
                ...
                _members[ 1 ].type = CustomerHelper.type();
    ...
    {
        Account new_one = new Account();

        new_one.accountNumber = istream.read_short();
        new_one.owner = CustomerHelper.read(istream);
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream, Account value)
    {
        ...
        CustomerHelper.write( ostream, value.owner );
