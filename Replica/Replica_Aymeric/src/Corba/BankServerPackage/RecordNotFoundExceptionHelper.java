...
public class RecordNotFoundExceptionHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, RecordNotFoundException t)
    {
        a.insert_Streamable(new RecordNotFoundExceptionHolder(t));
    }
     ...
     */
    public static RecordNotFoundException extract(org.omg.CORBA.Any a )
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.orb.core.Any) {
            ...
            try {
                ...
                if ( s instanceof RecordNotFoundExceptionHolder)
                    return ( (RecordNotFoundExceptionHolder) s ).value;
            }
            catch ( org.omg.CORBA.BAD_INV_ORDER ex )
            {
            }
            RecordNotFoundExceptionHolder h = new RecordNotFoundExceptionHolder( read( a.create_input_stream() ) );
     ...
     */
    public static RecordNotFoundException read(org.omg.CORBA.portable.InputStream istream)
    {
        RecordNotFoundException new_one = new RecordNotFoundException();
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, RecordNotFoundException value)
    {
